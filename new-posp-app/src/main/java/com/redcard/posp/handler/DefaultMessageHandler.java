...
public class DefaultMessageHandler implements IMessageHandler {
    ...
    public static void returnOrgMessage(Message msg, Channel inBoundChannel, String responseCode) {
        if (msg != null) {
            ...
            //@TODO 处理返回给新国都错误的情况
            if (!ResultCode.RESULT_CODE_00.getCode().equals(responseCode)) {
                msg.setBCDField(37, "303030303030303030303031");
                msg.setBCDField(64, "");
            }
    ...
    public static String getMAC(Message msg) {
        ...
        if(StringUtils.isBlank(pos.getFldMacKey())||StringUtils.isBlank(pos.getFldMasterKey())){
            return "";
        }
