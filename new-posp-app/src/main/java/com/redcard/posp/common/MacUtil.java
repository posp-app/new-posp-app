	...
	public static String xOrString(String pan,String pin)
		{
			...
			byte [] bytepan = TypeConvert.hexStringToByte(pan);
			byte [] bytepin = TypeConvert.hexStringToByte(pin);
			...
			return TypeConvert.bytes2HexString(result);
		}
		...
		public static String Mac_919(String key,String vector,String data)
		{
			...
			String mac = MAC(left,vector,data);
